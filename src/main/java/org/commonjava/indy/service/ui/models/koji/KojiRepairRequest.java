 ...
 */
package org.commonjava.indy.service.ui.models.koji;
...
{
    @Schema( description = "Koji repository key to repair (formatted as: '{maven}:{remote,group}:name')",
             required = true )
    private StoreKey source;

    @Schema( description = "Repair arguments" )
    private String args;

    @Schema( description = "Get repair report ONLY, not modify anything." )
