 ...
 */
package org.commonjava.indy.service.ui.models.stats;
...
@Schema( description = "Description of an add-on" )
        ...
        implements Comparable<IndyAddOnID>
{
    ...
    @Schema( description = "List of router entries (mainly for use in the UI)" )
    private List<UIRoute> routes;

    @Schema( description = "List of menu sections (mainly for use in the UI)" )
    private List<UISection> sections;

    @Schema( description = "Path to the Javascript needed to drive the UI for this add-on" )
