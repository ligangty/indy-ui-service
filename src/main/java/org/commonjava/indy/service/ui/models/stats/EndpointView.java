 ...
 */
@Schema( description = "Artifact store information necessary for accessing or referencing (for replicating from another Indy instance, or from another repository manager)" )
    ...
    implements Comparable<EndpointView>
{
    ...
    @Schema( description = "URL for accessing this artifact store" )
