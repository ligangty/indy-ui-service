 ...
 */
@Schema(
        description = "Listing of available artifact stores on the system, with the information necessary to access/reference each (for replicating from another Indy instance, or another remote repository manager)" )
