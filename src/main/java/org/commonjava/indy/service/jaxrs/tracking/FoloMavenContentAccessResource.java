 ...
 */
package org.commonjava.indy.service.jaxrs.tracking;

import org.commonjava.indy.service.client.tracking.FoloMavenContentAccessServiceClient;
...
public class FoloMavenContentAccessResource
{
    @Inject
    @RestClient
    FoloMavenContentAccessServiceClient client;
