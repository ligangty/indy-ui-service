...
{
    @Schema( required = true, description = "Whether validation succeeded" )
    private boolean valid = true;

    @Schema( description = "Mapping of rule name to error message for any failing validations" )
    private Map<String, String> validatorErrors = new HashMap<>();

    @Schema( description = "Name of validation rule-set applied" )
    ...
    {
        return "ValidationResult{" + "valid=" + valid + ", validatorErrors=" + validatorErrors + ", ruleSet='" + ruleSet
                + '\'' + '}';
    }
}
